                ...
                <div className={`flex flex-col h-full ${!currentWord ? 'opacity-50 pointer-events-none' : ''}`}>
                    ...
                    <div className="relative mb-4">
                        <input
                            ...
                            className={`w-full text-3xl font-mono font-bold p-4 rounded-xl border-4 outline-none transition-colors ${
                                teacherTypedSpelling.length === 0 ? 'border-stone-200' : 
                    ...
                    <div className="mt-auto">
                        <button
                            ...
                            className={`w-full py-4 rounded-xl font-bold text-lg shadow-lg flex items-center justify-center gap-2 transition-all active:scale-95 ${
                                isMatch && protocolOpened && protocolClosed
                                            ...
                                            <td key={colIndex} className={`p-2 text-center border-l border-stone-100 align-top ${colIndex >= 5 ? 'bg-purple-50/30' : ''}`}>
                                                {attempt ? (
                                                    <div className={`flex flex-col items-center rounded-lg p-2 ${
                                                        attempt.result === 'skipped' ? 'bg-stone-100 border-stone-200 opacity-50' :
              ...
              <tr key={i} className="bg-white">
                ...
                <td className="p-4">
                  <span className={`px-2 py-1 rounded-full text-xs font-bold ${
                    attempt.result === 'correct' ? 'bg-green-100 text-green-700' : 
